...
def process_and_validate(raw_rows: list[dict], max_chars_per_line: int = 22, max_chars_line3: int | None = None, extract_kiszereles: bool = False) -> dict:
    """
    ...
    for i, raw_row in enumerate(raw_rows):
        result = process_row(raw_row, i, max_chars_per_line=max_chars_per_line, max_chars_line3=max_chars_line3, extract_kiszereles=extract_kiszereles)
